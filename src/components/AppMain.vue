			...
			<div class="flex flex-col w-full max-w-sm shadow bg-white p-4">
				...
				<ul class="flex flex-row space-x-3 overflow-x-auto py-4 px-2 mt-2">
					<li>
						<div class="relative">
							<span
								class="absolute left-0 top-0 -mt-1 -ml-1 flex items-center justify-center h-6 w-6 rounded-full bg-blue-500 text-white"
							>
					...
					<li>
						<a href="#" class="flex rounded-full border-2 border-blue-200 p-px w-16 h-16">
							<img
								src="https://images.unsplash.com/photo-1568967729548-e3dbad3d37e0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&w=128&h=128&q=60&facepad=1.5"
								alt
								class="avatar"
							/>
						</a>
					...
					<li>
						<a href="#" class="flex rounded-full border-2 border-blue-200 p-px w-16 h-16">
							<img
								src="https://images.unsplash.com/photo-1557296387-5358ad7997bb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&w=128&h=128&q=60&facepad=1.5"
								alt
								class="avatar"
							/>
						</a>
					...
					<li>
						<a href="#" class="flex rounded-full border-2 border-blue-200 p-px w-16 h-16">
							<img
								src="https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&w=128&h=128&q=60&facepad=1.5"
								alt
								class="avatar"
							/>
						</a>
				...
				<div class="flex flex-col relative mt-4">
					...
					<div>
						<input
							class="pl-10 rounded h-10 w-full focus:outline-none bg-gray-200 focus:bg-gray-300"
							type="text"
						/>
					</div>
				</div>
				<ul class="flex flex-col mt-4 space-y-2 overflow-y-auto h-400">
					...
					<li class="flex flex-row items-center relative hover:bg-gray-100 p-2 rounded">
						...
						<div class="relative flex-shrink-0">
							...
							<a href="#" class="flex rounded-full w-16 h-16">
								<img
									src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&w=128&h=128&q=60&facepad=1.5"
									alt
									class="avatar"
								/>
							</a>
					...
					<li class="flex flex-row items-center relative hover:bg-gray-100 p-2 rounded">
						<div class="relative flex-shrink-0">
							...
							<a href="#" class="flex rounded-full w-16 h-16">
								<img
									src="https://images.unsplash.com/photo-1493106819501-66d381c466f1?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&w=128&h=128&q=60&facepad=1.5"
									alt
									class="avatar"
								/>
							</a>
					...
					<li class="flex flex-row items-center relative hover:bg-gray-100 p-2 rounded">
						<div class="relative flex-shrink-0">
							...
							<a href="#" class="flex rounded-full w-16 h-16">
								<img
									src="https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&w=128&h=128&q=60&facepad=1.5"
									alt
									class="avatar"
								/>
							</a>
...
.badge {
	@apply absolute right-0 top-0 border-2 border-white mt-px mr-px flex items-center justify-center h-4 w-4 rounded-full bg-green-500;
}
</style>
